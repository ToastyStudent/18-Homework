...
// and to return all thoughts when accessed with a GET request using their respective controller methods
// imported from the thought-controller.js file above.
...
// using their respective controller methods imported from the thought-controller.js file above.
...
// by that thought's _id when accessed with a POST request using the addReaction method imported from the thought-controller.js file above.
router.route('/:thoughtId/reactions').post(addReaction);

// /api/thoughts/:thoughtId/reactions/:reactionId is used for deleting a reaction by the reaction's reactionId 
// value when accessed with a DELETE request using the removeReaction method imported from the thought-controller.js file above.
